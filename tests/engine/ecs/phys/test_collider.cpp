...
TEST_CASE("Collider", "[Collider]") {
  ...
  SECTION("Collision Layers") {
    ...
    sbl::Collider rect1(sbl::Rect(sbl::Vector2::Zero(), sbl::Vector2(1,1)), 1);
    sbl::Collider circle1(sbl::Circle(sbl::Vector2::Zero(),1), 1);
    ...
    sbl::Collider rect2(sbl::Rect(sbl::Vector2::Zero(), sbl::Vector2(1,1)), 4);
    sbl::Collider circle2(sbl::Circle(sbl::Vector2::Zero(),1), 4);
  ...
  SECTION("Kissing Rectangle Collider Collision") {
    ...
    sbl::BitMask bm;
    bm.AddBit(1);
    sbl::Collider a(sbl::Rect(sbl::Vector2(0,0), sbl::Vector2(2,4)), 1);
    sbl::Collider b(sbl::Rect(sbl::Vector2(2,0), sbl::Vector2(2,4)), 1);
    sbl::Collider c(sbl::Rect(sbl::Vector2(0,4), sbl::Vector2(2,4)), 1);
    sbl::Collider d(sbl::Rect(sbl::Vector2(2,4), sbl::Vector2(2,4)), 1);
  ...
  SECTION("Calculate Overlapping Rectangle Collisions") {
    ...
    sbl::Collider a(sbl::Rect(sbl::Vector2(0,0), sbl::Vector2(3,4)), 1);
    sbl::Collider b(sbl::Rect(sbl::Vector2(1,2), sbl::Vector2(5,7)), 1);
    sbl::Collider c(sbl::Rect(sbl::Vector2(5,6), sbl::Vector2(3,4)), 1);
    sbl::Collider d(sbl::Rect(sbl::Vector2(2,0), sbl::Vector2(1,6)), 1);
  ...
  SECTION("Calculate Kissing Circle Collision") {
    ...
    sbl::Collider a(sbl::Circle(sbl::Vector2::Zero(), 1), 1);
    sbl::Collider b(sbl::Circle(sbl::Vector2(2,0), 1), 1);
    sbl::Collider c(sbl::Circle(sbl::Vector2(0,2), 1), 1);
    // sqrt(2) LOL. Testing a collision at a 45 degree angle
    sbl::Collider d(sbl::Circle(sbl::Vector2(1.41421356237309504,1.41421356237309504), 1), 1);
  ...
  SECTION("Calculate Overlapping Circle Collision") {
    ...
    sbl::Collider a(sbl::Circle(sbl::Vector2::Zero(), 1), 1);
    sbl::Collider b(sbl::Circle(sbl::Vector2(2,0), 5), 1);
    sbl::Collider c(sbl::Circle(sbl::Vector2(0,3), 1), 1);
  ...
  SECTION("Calculate Kissing Rect and Circle Collisions") {
    ...
    sbl::Collider rect(sbl::Rect(sbl::Vector2(0,0), sbl::Vector2(3,4)), 1);
    sbl::Collider circle1(sbl::Circle(sbl::Vector2(-1,1), 1), 1);
    sbl::Collider circle2(sbl::Circle(sbl::Vector2(4,2), 1), 1);
    sbl::Collider circle3(sbl::Circle(sbl::Vector2(2,-1), 1), 1);
    sbl::Collider circle4(sbl::Circle(sbl::Vector2(2,5), 1), 1);
    sbl::Collider circle5(sbl::Circle(sbl::Vector2(-sbl::Math::Sqrt(1/2),4 + sbl::Math::Sqrt(1/2)), 1), 1);
